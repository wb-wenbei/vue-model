<template>
  <div class="tabs-box">
    <el-tabs v-model="activeName">
      <el-tab-pane name="dataCount" @click.native="activeName = 'dataCount'">
        ...
        <div class="count-content">
          ...
          <div class="flex-5">
            <count-card title="考核策略考核评价占比"></count-card>
          </div>
        </div>
        <div class="count-content">
          <div class="flex-3">
...
export default {
  name: "DataCount",
  components: { CountCard, CommonChart, CommunityCheck },
  data() {
    return {
      activeName: "dataCount",
      form: {
        monthTime: Date.now()
      },
      chartOptions: {
      ...
      rankData: [
        ...
        { id: 2, communityName: "虹桥社区", score: 98 },
        { id: 3, communityName: "虹桥社区", score: 98 },
        { id: 4, communityName: "虹桥社区", score: 98 },
        { id: 5, communityName: "虹桥社区", score: 98 },
        { id: 6, communityName: "虹桥社区", score: 98 },
        { id: 7, communityName: "虹桥社区", score: 98 },
        { id: 8, communityName: "虹桥社区", score: 98 },
        { id: 9, communityName: "虹桥社区", score: 98 },
        { id: 10, communityName: "虹桥社区", score: 98 }
      ],
      checkedList: []
    };
  },
